...
class CreditCardItemDelete extends StatelessWidget {
  const CreditCardItemDelete({super.key});
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  width: 2,
                  color: Color.fromARGB(255, 100, 13, 222).withOpacity(0.5)),
                    ...
                    Row(
                        ...
                        children: items1.map((e) {
                          return Container(
                            ...
                            width: 25,
                            child: Icon(
                              e != 3 ? Icons.check_rounded : Icons.star_rounded,
                              color: e != 3
                ...
                child: Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: const Color.fromARGB(255, 70, 78, 127)),
                    child: Column(
          ...
          Positioned(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          width: 2,
                          color: const Color.fromARGB(255, 173, 196, 96)),
